...
const columns: Column<RowData>[] = [
    ...
    {
        Header: () => <div className="flex items-Center  gap-x-2"> Est. Value</div>,
        accessor: "estValue",
        Cell:({ value } :CellProps<RowData, string>) => (
            <div className="text-gray-700">{value || <span className="text-gray-300">-</span>}</div>
        ),
    ...
    return (
        <div className=" flex-1 overflow-x-auto w-[100%] scrollbar-hidden">
            <div className=" flex w-full">
                ...
                <div className="flex px-2 py-1 text-sm truncate gap-2 items-center bg-[#e2e2e2] border border-[#eeeeee] content-center w-[650px]">
                ...
                <div className="px-2 py-1 truncate w-[150px] text-sm text-gray-700 border border-[#eeeeee]"></div>

                <div className="flex items-center justify-center gap-1 py-1 px-2 text-sm bg-[#d2e0d4] text-gray-600 truncate border border-[#eeeeee] cursor-pointer">
                ...
                <div className="px-2 py-1 text-sm text-gray-600 truncate flex items-center justify-center gap-1 bg-[#DCCFFC] border border-[#eeeeee] cursor-pointer w-[300px]">
                ...
                <div className="px-2 py-1 text-sm text-gray-700 truncate border border-[#eeeeee] flex items-center justify-center bg-[#fac2af] gap-1 cursor-pointer w-[150px]">
                ...
                <div className="px-2 py-1 text-sm text-gray-700 truncate border border-[#eeeeee] bg-[#eeeeee] flex items-center justify-center cursor-pointer w-[150px]">
                            ...
                            <tr {...headerGroup.getHeaderGroupProps()}>
                                {headerGroup.headers.map((column: ColumnInstance<RowData>) => (
                                    <th
                                        ...
                                        className=" relative border p-2 text-left font-semibold text-gray-600 bg-[#F3F3F3] "
                                    >
